...
function (_React$Component) {
  styleInject_es._inherits(InnerContentHeightScrollbar, _React$Component);

  function InnerContentHeightScrollbar() {
    styleInject_es._classCallCheck(this, InnerContentHeightScrollbar);

    return styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(InnerContentHeightScrollbar).apply(this, arguments));
  }

  styleInject_es._createClass(InnerContentHeightScrollbar, [{
    key: "onHeightReady",
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = styleInject_es._objectWithoutProperties(_this$props, ["className", "children", "forwardRef"]);

      return React__default.createElement(scrollbar, styleInject_es._extends({
...
}(React__default.Component), (styleInject_es._applyDecoratedDescriptor(_class.prototype, "onHeightReady", [index$1.autobind], Object.getOwnPropertyDescriptor(_class.prototype, "onHeightReady"), _class.prototype), styleInject_es._applyDecoratedDescriptor(_class.prototype, "setRef", [index$1.autobind], Object.getOwnPropertyDescriptor(_class.prototype, "setRef"), _class.prototype)), _class);
/**
...
var ContentHeightScrollbar = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(InnerContentHeightScrollbar, styleInject_es._extends({}, props, {
    forwardRef: ref
  }));
});
