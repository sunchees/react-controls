...
var gud = function() {
  return index$2.commonjsGlobal[key] = (index$2.commonjsGlobal[key] || 0) + 1;
};
...
function createReactContext(defaultValue, calculateChangedBits) {
  ...
  Provider.childContextTypes = (_Provider$childContex = {}, _Provider$childContex[contextProp] = index$2.PropTypes.object.isRequired, _Provider$childContex);
  ...
  Consumer.contextTypes = (_Consumer$contextType = {}, _Consumer$contextType[contextProp] = index$2.PropTypes.object, _Consumer$contextType);
  return {
    Provider: Provider,
    Consumer: Consumer
  };
...
var TYPE_STATICS = {};
TYPE_STATICS[index$2.reactIs.ForwardRef] = FORWARD_REF_STATICS;

function getStatics(component) {
  if (index$2.reactIs.isMemo(component)) {
    return MEMO_STATICS;
  }
...
if (process.env.NODE_ENV !== "production") {
  Router.propTypes = {
    children: index$2.PropTypes.node,
    history: index$2.PropTypes.object.isRequired,
    staticContext: index$2.PropTypes.object
  };
...
if (process.env.NODE_ENV !== "production") {
  MemoryRouter.propTypes = {
    initialEntries: index$2.PropTypes.array,
    initialIndex: index$2.PropTypes.number,
    getUserConfirmation: index$2.PropTypes.func,
    keyLength: index$2.PropTypes.number,
    children: index$2.PropTypes.node
  };
...
if (process.env.NODE_ENV !== "production") {
  var messageType = index$2.PropTypes.oneOfType([index$2.PropTypes.func, index$2.PropTypes.string]);
  Prompt.propTypes = {
    when: index$2.PropTypes.bool,
...
if (process.env.NODE_ENV !== "production") {
  Redirect.propTypes = {
    push: index$2.PropTypes.bool,
    from: index$2.PropTypes.string,
    to: index$2.PropTypes.oneOfType([index$2.PropTypes.string, index$2.PropTypes.object]).isRequired
  };
}
...
if (process.env.NODE_ENV !== "production") {
  Route.propTypes = {
    children: index$2.PropTypes.oneOfType([index$2.PropTypes.func, index$2.PropTypes.node]),
    component: function component(props, propName) {
      if (props[propName] && !index$2.reactIs_1(props[propName])) {
        return new Error("Invalid prop 'component' supplied to 'Route': the prop is not a valid React component");
      }
    },
    exact: index$2.PropTypes.bool,
    location: index$2.PropTypes.object,
    path: index$2.PropTypes.oneOfType([index$2.PropTypes.string, index$2.PropTypes.arrayOf(index$2.PropTypes.string)]),
    render: index$2.PropTypes.func,
    sensitive: index$2.PropTypes.bool,
    strict: index$2.PropTypes.bool
  };
...
if (process.env.NODE_ENV !== "production") {
  StaticRouter.propTypes = {
    basename: index$2.PropTypes.string,
    context: index$2.PropTypes.object,
    location: index$2.PropTypes.oneOfType([index$2.PropTypes.string, index$2.PropTypes.object])
  };
...
function withRouter(Component) {
  ...
  if (process.env.NODE_ENV !== "production") {
    C.propTypes = {
      wrappedComponentRef: index$2.PropTypes.oneOfType([index$2.PropTypes.string, index$2.PropTypes.func, index$2.PropTypes.object])
    };
  }
...
if (process.env.NODE_ENV !== "production") {
  BrowserRouter.propTypes = {
    basename: index$2.PropTypes.string,
    children: index$2.PropTypes.node,
    forceRefresh: index$2.PropTypes.bool,
    getUserConfirmation: index$2.PropTypes.func,
    keyLength: index$2.PropTypes.number
  };
...
if (process.env.NODE_ENV !== "production") {
  HashRouter.propTypes = {
    ...
    children: index$2.PropTypes.node,
    getUserConfirmation: index$2.PropTypes.func,
    hashType: index$2.PropTypes.oneOf(["hashbang", "noslash", "slash"])
  };
...
if (process.env.NODE_ENV !== "production") {
  var toType = index$2.PropTypes.oneOfType([index$2.PropTypes.string, index$2.PropTypes.object, index$2.PropTypes.func]);
  var refType = index$2.PropTypes.oneOfType([index$2.PropTypes.string, index$2.PropTypes.func, index$2.PropTypes.shape({
    current: index$2.PropTypes.any
  })]);
  Link.displayName = "Link";
  Link.propTypes = {
    innerRef: refType,
    onClick: index$2.PropTypes.func,
    replace: index$2.PropTypes.bool,
    target: index$2.PropTypes.string,
...
if (process.env.NODE_ENV !== "production") {
  ...
  var ariaCurrentType = index$2.PropTypes.oneOf(["page", "step", "location", "date", "time", "true"]);
  NavLink.propTypes = _extends({}, Link.propTypes, {
    "aria-current": ariaCurrentType,
    activeClassName: index$2.PropTypes.string,
    activeStyle: index$2.PropTypes.object,
    className: index$2.PropTypes.string,
    exact: index$2.PropTypes.bool,
    isActive: index$2.PropTypes.func,
    location: index$2.PropTypes.object,
    strict: index$2.PropTypes.bool,
    style: index$2.PropTypes.object
  });
}

var css = ".router-link > a,\r\n.router-link > a:focus,\r\n.router-link > a:hover,\r\n.router-link > a:active {\r\n  outline: none;\r\n}\r\n.router-link {\r\n  color: #424242;\r\n}\r\n";
...
function (_React$PureComponent) {
  styleInject_es._inherits(RouterLink, _React$PureComponent);

  function RouterLink() {
    styleInject_es._classCallCheck(this, RouterLink);

    return styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(RouterLink).apply(this, arguments));
  }

  styleInject_es._createClass(RouterLink, [{
    key: "isActive",
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = styleInject_es._objectWithoutProperties(_this$props, ["className", "children", "pattern", "location", "history"]);

      return React__default.createElement(Link, styleInject_es._extends({}, props, {
...
var index$1 = withRouter(RouterLink);
RouterLink.propTypes = styleInject_es._objectSpread2({}, RouterLink.propTypes, {
  /**
   ...
   */
  pattern: index$2.PropTypes.string
});
