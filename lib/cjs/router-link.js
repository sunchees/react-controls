...
var index$1$1 = require('./index-dbbea75d.js');
...
function createReactContext(defaultValue, calculateChangedBits) {
  ...
  Provider.childContextTypes = (_Provider$childContex = {}, _Provider$childContex[contextProp] = index$1$1.PropTypes.object.isRequired, _Provider$childContex);
  ...
  Consumer.contextTypes = (_Consumer$contextType = {}, _Consumer$contextType[contextProp] = index$1$1.PropTypes.object, _Consumer$contextType);
  return {
    Provider: Provider,
    Consumer: Consumer
  };
...
var TYPE_STATICS = {};
TYPE_STATICS[index$1$1.reactIs.ForwardRef] = FORWARD_REF_STATICS;

function getStatics(component) {
  if (index$1$1.reactIs.isMemo(component)) {
    return MEMO_STATICS;
  }
...
if (process.env.NODE_ENV !== "production") {
  Router.propTypes = {
    children: index$1$1.PropTypes.node,
    history: index$1$1.PropTypes.object.isRequired,
    staticContext: index$1$1.PropTypes.object
  };
...
if (process.env.NODE_ENV !== "production") {
  MemoryRouter.propTypes = {
    initialEntries: index$1$1.PropTypes.array,
    initialIndex: index$1$1.PropTypes.number,
    getUserConfirmation: index$1$1.PropTypes.func,
    keyLength: index$1$1.PropTypes.number,
    children: index$1$1.PropTypes.node
  };
...
if (process.env.NODE_ENV !== "production") {
  var messageType = index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.func, index$1$1.PropTypes.string]);
  Prompt.propTypes = {
    when: index$1$1.PropTypes.bool,
...
if (process.env.NODE_ENV !== "production") {
  Redirect.propTypes = {
    push: index$1$1.PropTypes.bool,
    from: index$1$1.PropTypes.string,
    to: index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.string, index$1$1.PropTypes.object]).isRequired
  };
}
...
if (process.env.NODE_ENV !== "production") {
  Route.propTypes = {
    children: index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.func, index$1$1.PropTypes.node]),
    component: function component(props, propName) {
      if (props[propName] && !index$1$1.reactIs_1(props[propName])) {
        return new Error("Invalid prop 'component' supplied to 'Route': the prop is not a valid React component");
      }
    },
    exact: index$1$1.PropTypes.bool,
    location: index$1$1.PropTypes.object,
    path: index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.string, index$1$1.PropTypes.arrayOf(index$1$1.PropTypes.string)]),
    render: index$1$1.PropTypes.func,
    sensitive: index$1$1.PropTypes.bool,
    strict: index$1$1.PropTypes.bool
  };
...
if (process.env.NODE_ENV !== "production") {
  StaticRouter.propTypes = {
    basename: index$1$1.PropTypes.string,
    context: index$1$1.PropTypes.object,
    location: index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.string, index$1$1.PropTypes.object])
  };
...
function withRouter(Component) {
  ...
  if (process.env.NODE_ENV !== "production") {
    C.propTypes = {
      wrappedComponentRef: index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.string, index$1$1.PropTypes.func, index$1$1.PropTypes.object])
    };
  }
...
if (process.env.NODE_ENV !== "production") {
  BrowserRouter.propTypes = {
    basename: index$1$1.PropTypes.string,
    children: index$1$1.PropTypes.node,
    forceRefresh: index$1$1.PropTypes.bool,
    getUserConfirmation: index$1$1.PropTypes.func,
    keyLength: index$1$1.PropTypes.number
  };
...
if (process.env.NODE_ENV !== "production") {
  HashRouter.propTypes = {
    ...
    children: index$1$1.PropTypes.node,
    getUserConfirmation: index$1$1.PropTypes.func,
    hashType: index$1$1.PropTypes.oneOf(["hashbang", "noslash", "slash"])
  };
...
if (process.env.NODE_ENV !== "production") {
  var toType = index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.string, index$1$1.PropTypes.object, index$1$1.PropTypes.func]);
  var refType = index$1$1.PropTypes.oneOfType([index$1$1.PropTypes.string, index$1$1.PropTypes.func, index$1$1.PropTypes.shape({
    current: index$1$1.PropTypes.any
  })]);
  Link.displayName = "Link";
  Link.propTypes = {
    innerRef: refType,
    onClick: index$1$1.PropTypes.func,
    replace: index$1$1.PropTypes.bool,
    target: index$1$1.PropTypes.string,
...
if (process.env.NODE_ENV !== "production") {
  ...
  var ariaCurrentType = index$1$1.PropTypes.oneOf(["page", "step", "location", "date", "time", "true"]);
  NavLink.propTypes = _extends({}, Link.propTypes, {
    "aria-current": ariaCurrentType,
    activeClassName: index$1$1.PropTypes.string,
    activeStyle: index$1$1.PropTypes.object,
    className: index$1$1.PropTypes.string,
    exact: index$1$1.PropTypes.bool,
    isActive: index$1$1.PropTypes.func,
    location: index$1$1.PropTypes.object,
    strict: index$1$1.PropTypes.bool,
    style: index$1$1.PropTypes.object
  });
}
  ...
  _rollupPluginBabelHelpers._createClass(RouterLink, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_this$props, ["className", "to", "children", "pattern", "location", "history"]);

      return React__default.createElement(Link, _rollupPluginBabelHelpers._extends({}, props, {
