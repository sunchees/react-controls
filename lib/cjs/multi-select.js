...
var isBuffer_1 = index.createCommonjsModule(function (module, exports) {
...
var _nodeUtil = index.createCommonjsModule(function (module, exports) {
/** Detect free variable `exports`. */
var freeExports =  exports && !exports.nodeType && exports;
...
function (_React$PureComponent) {
  styleInject_es._inherits(DefaultMultiSelectListItem, _React$PureComponent);

  function DefaultMultiSelectListItem() {
    styleInject_es._classCallCheck(this, DefaultMultiSelectListItem);

    return styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(DefaultMultiSelectListItem).apply(this, arguments));
  }

  styleInject_es._createClass(DefaultMultiSelectListItem, [{
    key: "onDeselectClick",
...
}(React__default.PureComponent), (styleInject_es._applyDecoratedDescriptor(_class.prototype, "onDeselectClick", [index$1.autobind], Object.getOwnPropertyDescriptor(_class.prototype, "onDeselectClick"), _class.prototype)), _class);
/**
...
function (_React$Component) {
  styleInject_es._inherits(MultiSelect, _React$Component);

  function MultiSelect(props) {
    var _this;

    styleInject_es._classCallCheck(this, MultiSelect);

    _this = styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(MultiSelect).call(this, props));
    _this.state = {
  ...
  styleInject_es._createClass(MultiSelect, [{
    ...
    value: function selectItem(item) {
      if (item) {
        this.setState({
          selected: [].concat(styleInject_es._toConsumableArray(this.state.selected), [item])
        });
    ...
    value: function render() {
      ...
      }, React__default.createElement(comboBox, styleInject_es._extends({}, comboBoxProps, {
