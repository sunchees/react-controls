...
function (_React$PureComponent) {
  styleInject_es._inherits(Textarea, _React$PureComponent);

  function Textarea(props) {
    var _this;

    styleInject_es._classCallCheck(this, Textarea);

    _this = styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(Textarea).call(this, props));
    _this.input = null;
    _this.ie = isInternetExplorer();
    return _this;
  }

  styleInject_es._createClass(Textarea, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = styleInject_es._objectWithoutProperties(_this$props, ["className", "onKeyDown", "onEnterPress", "onEscapePress", "onChange", "onHeightChange", "onClipboardFilePaste", "name", "forwardRef"]);

      return React__default.createElement("textarea", styleInject_es._extends({}, props, {
