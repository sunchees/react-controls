...
var index$1$1 = require('./index-f47bf584.js');
...
var Textarea = index$1$1.autobind(_class =
/*#__PURE__*/
...
Textarea.propTypes = {
   ...
   */
  onEnterPress: index$1.PropTypes.func,

  /**
   * Убирает фокус с поля ввода при нажатии клавиши Enter.
   */
  blurOnEnter: index$1.PropTypes.bool,
   ...
   * @param {string=} name - название поля ввода, на основе заданного компоненту свойства "name"
   */
  onEscapePress: index$1.PropTypes.func,
   ...
   */
  forwardRef: index$1.PropTypes.func,
   ...
   */
  onHeightChange: index$1.PropTypes.func,
   ...
   * @param {string=} name - название поля ввода, на основе заданного компоненту свойства "name"
   */
  onClipboardFilePaste: index$1.PropTypes.func
};
