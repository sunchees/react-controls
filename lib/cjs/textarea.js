  ...
  _rollupPluginBabelHelpers._createClass(Textarea, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_this$props, ["className", "onKeyDown", "onEnterPress", "onChange", "onHeightChange", "onClipboardFilePaste", "name", "forwardRef"]);
