...
var Table = React__default.forwardRef(function (_ref2, ref) {
  var _ref2$className = _ref2.className,
      ...
      props = _rollupPluginBabelHelpers._objectWithoutProperties(_ref2, ["className"]);

  return React__default.createElement(ReactTable, _rollupPluginBabelHelpers._extends({
    ref: ref,
