  ...
  return function (_Base) {
    ...
    _createClass$1(_class, [{
      ...
      value: function fireFetchData() {
        ...
        var currentState = _extends$1({}, this.getResolvedState(), {
...
var ReactTablePagination = function (_Component) {
  ...
  function ReactTablePagination(props) {
    ...
    var _this = _possibleConstructorReturn$2(this, (ReactTablePagination.__proto__ || Object.getPrototypeOf(ReactTablePagination)).call(this, props));
...
var propTypes = {
  // General
  data: index.PropTypes.any,
  loading: index.PropTypes.bool,
  showPagination: index.PropTypes.bool,
  showPaginationTop: index.PropTypes.bool,
  showPaginationBottom: index.PropTypes.bool,
  showPageSizeOptions: index.PropTypes.bool,
  pageSizeOptions: index.PropTypes.array,
  defaultPageSize: index.PropTypes.number,
  showPageJump: index.PropTypes.bool,
  collapseOnSortingChange: index.PropTypes.bool,
  collapseOnPageChange: index.PropTypes.bool,
  collapseOnDataChange: index.PropTypes.bool,
  freezeWhenExpanded: index.PropTypes.bool,
  sortable: index.PropTypes.bool,
  resizable: index.PropTypes.bool,
  filterable: index.PropTypes.bool,
  defaultSortDesc: index.PropTypes.bool,
  defaultSorted: index.PropTypes.array,
  defaultFiltered: index.PropTypes.array,
  defaultResized: index.PropTypes.array,
  defaultExpanded: index.PropTypes.object,
  defaultFilterMethod: index.PropTypes.func,
  defaultSortMethod: index.PropTypes.func,

  // Controlled State Callbacks
  onPageChange: index.PropTypes.func,
  onPageSizeChange: index.PropTypes.func,
  onSortedChange: index.PropTypes.func,
  onFilteredChange: index.PropTypes.func,
  onResizedChange: index.PropTypes.func,
  onExpandedChange: index.PropTypes.func,

  // Pivoting
  pivotBy: index.PropTypes.array,

  // Key Constants
  pivotValKey: index.PropTypes.string,
  pivotIDKey: index.PropTypes.string,
  subRowsKey: index.PropTypes.string,
  aggregatedKey: index.PropTypes.string,
  nestingLevelKey: index.PropTypes.string,
  originalKey: index.PropTypes.string,
  indexKey: index.PropTypes.string,
  groupedByPivotKey: index.PropTypes.string,

  // Server-side Callbacks
  onFetchData: index.PropTypes.func,
  ...
  // Component decorators
  getProps: index.PropTypes.func,
  getTableProps: index.PropTypes.func,
  getTheadGroupProps: index.PropTypes.func,
  getTheadGroupTrProps: index.PropTypes.func,
  getTheadGroupThProps: index.PropTypes.func,
  getTheadProps: index.PropTypes.func,
  getTheadTrProps: index.PropTypes.func,
  getTheadThProps: index.PropTypes.func,
  getTheadFilterProps: index.PropTypes.func,
  getTheadFilterTrProps: index.PropTypes.func,
  getTheadFilterThProps: index.PropTypes.func,
  getTbodyProps: index.PropTypes.func,
  getTrGroupProps: index.PropTypes.func,
  getTrProps: index.PropTypes.func,
  getTdProps: index.PropTypes.func,
  getTfootProps: index.PropTypes.func,
  getTfootTrProps: index.PropTypes.func,
  getTfootTdProps: index.PropTypes.func,
  getPaginationProps: index.PropTypes.func,
  getLoadingProps: index.PropTypes.func,
  getNoDataProps: index.PropTypes.func,
  getResizerProps: index.PropTypes.func,

  // Global Column Defaults
  columns: index.PropTypes.arrayOf(index.PropTypes.shape({
    // Renderers
    Cell: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    Header: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    Footer: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    Aggregated: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    Pivot: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    PivotValue: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    Expander: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.string, index.PropTypes.func]),
    Filter: index.PropTypes.oneOfType([index.PropTypes.element, index.PropTypes.func]),

    // All Columns
    sortable: index.PropTypes.bool, // use table default
    resizable: index.PropTypes.bool, // use table default
    filterable: index.PropTypes.bool, // use table default
    show: index.PropTypes.bool,
    minWidth: index.PropTypes.number,
    minResizeWidth: index.PropTypes.number,
    ...
    // Pivot only
    aggregate: index.PropTypes.func,

    // Headers only
    headerClassName: index.PropTypes.string,
    headerStyle: index.PropTypes.object,
    getHeaderProps: index.PropTypes.func,

    // Footers only
    footerClassName: index.PropTypes.string,
    footerStyle: index.PropTypes.object,
    getFooterProps: index.PropTypes.func,
    filterMethod: index.PropTypes.func,
    filterAll: index.PropTypes.bool,
    sortMethod: index.PropTypes.func
  })),

  // Global Expander Column Defaults
  expanderDefaults: index.PropTypes.shape({
    sortable: index.PropTypes.bool,
    resizable: index.PropTypes.bool,
    filterable: index.PropTypes.bool,
  ...
  pivotDefaults: index.PropTypes.object,

  // Text
  previousText: index.PropTypes.node,
  nextText: index.PropTypes.node,
  loadingText: index.PropTypes.node,
  noDataText: index.PropTypes.node,
  pageText: index.PropTypes.node,
  ofText: index.PropTypes.node,
  rowsText: index.PropTypes.node,
  pageJumpText: index.PropTypes.node,
  rowsSelectorText: index.PropTypes.node,

  // Components
  TableComponent: index.PropTypes.elementType,
  TheadComponent: index.PropTypes.elementType,
  TbodyComponent: index.PropTypes.elementType,
  TrGroupComponent: index.PropTypes.elementType,
  TrComponent: index.PropTypes.elementType,
  ThComponent: index.PropTypes.elementType,
  TdComponent: index.PropTypes.elementType,
  TfootComponent: index.PropTypes.elementType,
  FilterComponent: index.PropTypes.elementType,
  ExpanderComponent: index.PropTypes.elementType,
  PivotValueComponent: index.PropTypes.elementType,
  AggregatedComponent: index.PropTypes.elementType,
  // this is a computed default generated using
  PivotComponent: index.PropTypes.elementType,
  // the ExpanderComponent and PivotValueComponent at run-time in methods.js
  PaginationComponent: index.PropTypes.elementType,
  PreviousComponent: index.PropTypes.elementType,
  NextComponent: index.PropTypes.elementType,
  LoadingComponent: index.PropTypes.elementType,
  NoDataComponent: index.PropTypes.elementType,
  ResizerComponent: index.PropTypes.elementType,
  PadRowComponent: index.PropTypes.elementType
};
...
var TableLoader = function TableLoader(_ref) {
  ...
  }, React__default.createElement(dashLoader, null), React__default.createElement(text, {
    value: loadingText
  }))) : null;
};
/**
...
var Table = React__default.forwardRef(function (_ref2, ref) {
  var _ref2$className = _ref2.className,
      className = _ref2$className === void 0 ? '' : _ref2$className,
      props = styleInject_es._objectWithoutProperties(_ref2, ["className"]);

  return React__default.createElement(ReactTable, styleInject_es._extends({
    ref: ref,
