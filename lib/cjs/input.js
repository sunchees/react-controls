  ...
  _rollupPluginBabelHelpers._createClass(Input, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_this$props, ["className", "error", "defaultValue", "value", "secure", "mask", "guide", "showMask", "onKeyDown", "onEnterPress", "onEscapeKeyPress", "onChange", "name", "forwardRef", "blurOnEnter"]);
