...
function (_React$Component) {
  _rollupPluginBabelHelpers._inherits(Input, _React$Component);
  ...
  function Input(props) {
    ...
    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(Input).call(this, props));
    _this.input = null;
  ...
  _rollupPluginBabelHelpers._createClass(Input, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_this$props, ["className", "error", "defaultValue", "value", "secure", "mask", "guide", "showMask", "onKeyDown", "onEnterPress", "onEscapePress", "onChange", "name", "forwardRef", "blurOnEnter"]);

      return React__default.createElement(MaskedInput, _rollupPluginBabelHelpers._extends({}, props, {
        key: this.state.key,
