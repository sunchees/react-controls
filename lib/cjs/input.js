...
var Input = index$1.autobind(_class =
/*#__PURE__*/
function (_React$Component) {
  styleInject_es._inherits(Input, _React$Component);

  function Input(props) {
    var _this;

    styleInject_es._classCallCheck(this, Input);

    _this = styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(Input).call(this, props));
    _this.input = null;
  ...
  styleInject_es._createClass(Input, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = styleInject_es._objectWithoutProperties(_this$props, ["className", "error", "defaultValue", "value", "secure", "mask", "guide", "showMask", "onKeyDown", "onEnterPress", "onEscapePress", "onChange", "name", "forwardRef", "blurOnEnter"]);

      return React__default.createElement(MaskedInput, styleInject_es._extends({}, props, {
        key: this.state.key,
...
Input.propTypes = {
   ...
   */
  onEnterPress: index.PropTypes.func,

  /**
   * Убирает фокус с поля ввода при нажатии клавиши Enter.
   */
  blurOnEnter: index.PropTypes.bool,
