...
var Input = index.autobind(_class =
/*#__PURE__*/
  ...
  _rollupPluginBabelHelpers._createClass(Input, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_this$props, ["className", "error", "defaultValue", "value", "secure", "placeholder", "disabled", "autoFocus", "mask", "guide", "showMask", "maxLength", "onFocus", "onBlur", "onKeyDown", "onEnterPress", "onEscapeKeyPress", "onChange", "name", "forwardRef", "blurOnEnter"]);
