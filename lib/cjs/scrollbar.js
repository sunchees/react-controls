...
function (_React$Component) {
  styleInject_es._inherits(Scrollbar, _React$Component);

  function Scrollbar(props) {
    var _this;

    styleInject_es._classCallCheck(this, Scrollbar);

    _this = styleInject_es._possibleConstructorReturn(this, styleInject_es._getPrototypeOf(Scrollbar).call(this, props));
    _this.values = {};
    _this.prevValues = {};
    _this.state = {
  ...
  styleInject_es._createClass(Scrollbar, [{
    key: "onScroll",
    value: function onScroll() {
      var values = this.scrollbar.getValues();
      if (this.props.onScroll) this.props.onScroll(styleInject_es._objectSpread2({}, this.values), values);

      if (this.values.top !== values.top) {
        if (values.top === 0 && this.props.onScrollToTop) this.props.onScrollToTop(styleInject_es._objectSpread2({}, this.values), values);
        if (values.top === 1 && this.props.onScrollToBottom) this.props.onScrollToBottom(styleInject_es._objectSpread2({}, this.values), values);
      }

      if (this.values.left !== values.left) {
        if (values.left === 0 && this.props.onScrollToLeft) this.props.onScrollToLeft(styleInject_es._objectSpread2({}, this.values), values);
        if (values.left === 1 && this.props.onScrollToRight) this.props.onScrollToRight(styleInject_es._objectSpread2({}, this.values), values);
      }
    }
  }, {
    key: "onUpdate",
    value: function onUpdate(values) {
      ...
      if (this.props.onUpdate) this.props.onUpdate(styleInject_es._objectSpread2({}, this.prevValues), values);
      this.values = values;
    }
  }, {
    key: "setRef",
    ...
    value: function renderThumb(_ref) {
      var style = _ref.style,
          props = styleInject_es._objectWithoutProperties(_ref, ["style"]);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = styleInject_es._objectWithoutProperties(_this$props, ["className", "children", "onScroll", "onScrollToTop", "onScrollToBottom", "onScrollToLeft", "onScrollToRight", "onUpdate"]);

      return React__default.createElement(Scrollbars, styleInject_es._extends({}, props, {
