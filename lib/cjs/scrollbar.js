...
var performanceNow = index.createCommonjsModule(function (module) {
...
var root = typeof window === 'undefined' ? index.commonjsGlobal : window
  , vendors = ['moz', 'webkit']
...
var isString_1 = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(isString_1);

var getScrollbarWidth_1 = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(getScrollbarWidth_1);

var returnFalse_1 = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(returnFalse_1);

var getInnerWidth_1 = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(getInnerWidth_1);

var getInnerHeight_1 = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(getInnerHeight_1);
...
var defaultRenderElements = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(defaultRenderElements);
...
var Scrollbars_1 = index.createCommonjsModule(function (module, exports) {
...
index.unwrapExports(Scrollbars_1);
...
var Scrollbars = index.unwrapExports(lib);
...
var Scrollbar = index$1.autobind(_class =
/*#__PURE__*/
function (_React$Component) {
  _rollupPluginBabelHelpers._inherits(Scrollbar, _React$Component);

  function Scrollbar(props) {
    var _this;

    _rollupPluginBabelHelpers._classCallCheck(this, Scrollbar);

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(Scrollbar).call(this, props));
    _this.values = {};
    _this.prevValues = {};
    _this.state = {
  ...
  _rollupPluginBabelHelpers._createClass(Scrollbar, [{
    key: "onScroll",
    value: function onScroll() {
      var values = this.scrollbar.getValues();
      if (this.props.onScroll) this.props.onScroll(_rollupPluginBabelHelpers._objectSpread2({}, this.values), values);

      if (this.values.top !== values.top) {
        if (values.top === 0 && this.props.onScrollToTop) this.props.onScrollToTop(_rollupPluginBabelHelpers._objectSpread2({}, this.values), values);
        if (values.top === 1 && this.props.onScrollToBottom) this.props.onScrollToBottom(_rollupPluginBabelHelpers._objectSpread2({}, this.values), values);
      }

      if (this.values.left !== values.left) {
        if (values.left === 0 && this.props.onScrollToLeft) this.props.onScrollToLeft(_rollupPluginBabelHelpers._objectSpread2({}, this.values), values);
        if (values.left === 1 && this.props.onScrollToRight) this.props.onScrollToRight(_rollupPluginBabelHelpers._objectSpread2({}, this.values), values);
      }
    }
  }, {
    key: "onUpdate",
    value: function onUpdate(values) {
      ...
      if (this.props.onUpdate) this.props.onUpdate(_rollupPluginBabelHelpers._objectSpread2({}, this.prevValues), values);
      this.values = values;
    }
  }, {
    key: "setRef",
    ...
    value: function renderThumb(_ref) {
      var style = _ref.style,
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_ref, ["style"]);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _rollupPluginBabelHelpers._objectWithoutProperties(_this$props, ["className", "children", "onScroll", "onScrollToTop", "onScrollToBottom", "onScrollToLeft", "onScrollToRight", "onUpdate"]);

      return React__default.createElement(Scrollbars, _rollupPluginBabelHelpers._extends({}, props, {
...
Scrollbar.propTypes = {
   ...
   * @param {Object} nextValues - значения расположения и размеров скроллбара, которые будут применены после обновления компонента
   */
  onScrollToTop: index.PropTypes.func,
   ...
   * @param {Object} nextValues - значения расположения и размеров скроллбара, которые будут применены после обновления компонента
   */
  onScrollToBottom: index.PropTypes.func,
   ...
   * @param {Object} nextValues - значения расположения и размеров скроллбара, которые будут применены после обновления компонента
   */
  onScrollToLeft: index.PropTypes.func,
   ...
   * @param {Object} nextValues - значения расположения и размеров скроллбара, которые будут применены после обновления компонента
   */
  onScrollToRight: index.PropTypes.func,
