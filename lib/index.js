  ...
  _createClass(ComboBoxSelectedItem, [{
    ...
    value: function render() {
      ...
      return React.createElement(Row, {
        className: "combo-box-selected-item ".concat(className)
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          name = _this$props.name,
          props = _objectWithoutProperties(_this$props, ["className", "showSelectedItem", "SelectedItemComponent", "ItemComponent", "items", "accessor", "defaultFilter", "defaultSelected", "onChange", "onFilterChange", "filterFunction", "error", "disabled", "inputProps", "scrollbarProps", "name"]);
