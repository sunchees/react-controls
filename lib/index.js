...
var Button = function Button(_ref) {
  var _ref$className = _ref.className,
      ...
      stylized = _ref.stylized,
      children = _ref.children,
      props = _objectWithoutProperties(_ref, ["className", "stylized", "children"]);

  return /*#__PURE__*/React.createElement("button", _extends({
    className: "button ".concat(stylized ? 'stylized' : '', " ").concat(className)
  }, props), children);
};
...
var DashLoader = function DashLoader(_ref) {
  ...
  }, props), /*#__PURE__*/React.createElement("span", null));
};
...
var ButtonWithLoader = function ButtonWithLoader(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    disabled: loading
  }, props), loading ? /*#__PURE__*/React.createElement(LoaderComponent, {
    className: "button-with-loader__loader"
  }) : children), success ? /*#__PURE__*/React.createElement(Text, {
...
var Checkbox = (_class = /*#__PURE__*/function (_React$PureComponent) {
...
var CheckboxWithLabel = (_class$1 = /*#__PURE__*/function (_React$Component) {
...
var Input = autobind(_class$2 = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(MaskedInput, _extends({}, props, {
        key: this.state.key,
...
var Scrollbar = autobind(_class$3 = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Scrollbar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Scrollbars, _extends({}, props, {
...
var _class$4;
var InnerContentHeightScrollbar = (_class$4 = /*#__PURE__*/function (_React$Component) {
  _inherits(InnerContentHeightScrollbar, _React$Component);

  var _super = _createSuper(InnerContentHeightScrollbar);
  ...
  _createClass(InnerContentHeightScrollbar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Scrollbar, _extends({
        ...
        ref: this.setRef
      }, props), /*#__PURE__*/React.createElement(lib, {
...
var ContentHeightScrollbar = React.forwardRef(function (props, ref) {
  return /*#__PURE__*/React.createElement(InnerContentHeightScrollbar, _extends({}, props, {
    forwardRef: ref
  }));
});
...
var _class$5;
var ComboBoxSelectedItem = (_class$5 = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ComboBoxSelectedItem, _React$PureComponent);

  var _super = _createSuper(ComboBoxSelectedItem);
...
var _class$6;
var ComboBoxItem = (_class$6 = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ComboBoxItem, _React$PureComponent);

  var _super = _createSuper(ComboBoxItem);
...
var ComboBox = autobind(_class$7 = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["className", "showSelectedItem", "SelectedItemComponent", "ItemComponent", "items", "accessor", "defaultFilter", "defaultSelected", "onChange", "onFilterChange", "disableFiltering", "filterFunction", "error", "disabled", "inputProps", "scrollbarProps", "name", "emptyText"]);

      var filtered = items ? disableFiltering ? items : items.filter(this.filterFunction) : [];
      return /*#__PURE__*/React.createElement("div", _extends({}, props, {
        ...
        onMouseDown: function onMouseDown(event) {
          ...
          */
          if (!_this2.state.open) event.target.focus();
        }
      }), this.state.selected && showSelectedItem ? /*#__PURE__*/React.createElement(SelectedItemComponent, {
      ...
      }, /*#__PURE__*/React.createElement(ContentHeightScrollbar, _extends({}, scrollbarProps, {
      ...
      }), !filtered.length && emptyText ? /*#__PURE__*/React.createElement(Text, {
        className: "combo-box__empty-text",
        value: emptyText
      }) : null)) : null);
    }
  }]);
...
var WrapWithLoader = function WrapWithLoader(_ref) {
  var _ref$className = _ref.className,
      className = _ref$className === void 0 ? '' : _ref$className,
      loading = _ref.loading,
      _ref$LoaderComponent = _ref.LoaderComponent,
      LoaderComponent = _ref$LoaderComponent === void 0 ? DashLoader : _ref$LoaderComponent,
      children = _ref.children,
      props = _objectWithoutProperties(_ref, ["className", "loading", "LoaderComponent", "children"]);

  return /*#__PURE__*/React.createElement(Row, _extends({
    className: "wrap-with-loader ".concat(className)
  }, props), children, loading ? /*#__PURE__*/React.createElement(LoaderComponent, {
    className: "wrap-with-loader__loader"
  }) : null);
};
...
var WrapWithLabel = function WrapWithLabel(_ref) {
  ...
  }, children instanceof Array && children.length ? children : children || (emptyText ? /*#__PURE__*/React.createElement(Text, {
...
var ComboBoxWithLabel = function ComboBoxWithLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "combo-box-with-label ".concat(className),
    label: label,
    mandatory: mandatory
  }, /*#__PURE__*/React.createElement(ComboBox, comboBoxProps));
};
...
var _class$8;
var DEFAULT_SEARCH_DELAY = 1000;
var DEFAULT_MINIMUM_FILTER_LENGTH = 3;
/**
 * Компонент выпадающего списка с фильтром, с логикой асинхронной загрузки данных в зависимости от фильтра.
 */

var ComboBoxWithExternalLoader = (_class$8 = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ComboBoxWithExternalLoader, _React$PureComponent);

  var _super = _createSuper(ComboBoxWithExternalLoader);

  function ComboBoxWithExternalLoader(props) {
    var _this;

    _classCallCheck(this, ComboBoxWithExternalLoader);

    _this = _super.call(this, props);
    _this.state = {
      data: [],
      loading: !!((props.comboBoxWithLabelProps || {}).comboBoxProps || {}).defaultSelected,
      filter: ''
    };
    _this.delayedSearch = null;
    return _this;
  }

  _createClass(ComboBoxWithExternalLoader, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this._isMounted = true;

      var _ref = (this.props.comboBoxWithLabelProps || {}).comboBoxProps || {},
          defaultSelected = _ref.defaultSelected,
          accessor = _ref.accessor;

      if (defaultSelected) {
        var defaultFilter = accessor ? typeof accessor === 'function' ? accessor(defaultSelected) : defaultSelected[name] : defaultSelected;
    ...
    value: function onFilterChange(filter) {
      ...
      if (filter.length >= this.props.minimumFilterLength) {
        this.delayedSearch = setTimeout(function () {
          _this2.getData(filter);
    ...
    value: function getData(filter) {
      ...
      this.props.getData(filter, function (data) {
    ...
    value: function render() {
      var _this$props = this.props,
          _this$props$className = _this$props.className,
          className = _this$props$className === void 0 ? '' : _this$props$className,
          minimumFilterLength = _this$props.minimumFilterLength,
          searchDelay = _this$props.searchDelay,
          getData = _this$props.getData,
          _this$props$comboBoxW = _this$props.comboBoxWithLabelProps,
          comboBoxWithLabelProps = _this$props$comboBoxW === void 0 ? {} : _this$props$comboBoxW,
          props = _objectWithoutProperties(_this$props, ["className", "minimumFilterLength", "searchDelay", "getData", "comboBoxWithLabelProps"]);

      var _comboBoxWithLabelPro = comboBoxWithLabelProps.comboBoxProps,
          inputProps = _comboBoxWithLabelPro.inputProps,
          comboBoxProps = _objectWithoutProperties(_comboBoxWithLabelPro, ["inputProps"]);

      return /*#__PURE__*/React.createElement(WrapWithLoader, _extends({}, props, {
        className: "combo-box-with-external-loader ".concat(className),
        loading: this.state.loading
      }), /*#__PURE__*/React.createElement(ComboBoxWithLabel, _extends({}, comboBoxWithLabelProps, {
        comboBoxProps: _objectSpread2(_objectSpread2({}, comboBoxProps), {}, {
          items: this.state.data,
          onFilterChange: this.onFilterChange,
          inputProps: _objectSpread2({
            placeholder: "\u0414\u043B\u044F \u043F\u043E\u0438\u0441\u043A\u0430 \u0432\u0432\u0435\u0434\u0438\u0442\u0435 ".concat(minimumFilterLength, " \u0441\u0438\u043C\u0432\u043E\u043B\u0430")
          }, inputProps),
          disableFiltering: true,
          emptyText: this.state.loading || this.state.filter.length < minimumFilterLength ? null : 'Ничего не найдено'
        })
      })));
    }
  }]);

  return ComboBoxWithExternalLoader;
}(React.PureComponent), (_applyDecoratedDescriptor(_class$8.prototype, "onFilterChange", [autobind], Object.getOwnPropertyDescriptor(_class$8.prototype, "onFilterChange"), _class$8.prototype), _applyDecoratedDescriptor(_class$8.prototype, "getData", [autobind], Object.getOwnPropertyDescriptor(_class$8.prototype, "getData"), _class$8.prototype)), _class$8);
...
var _class$9;
var DropdownItem = (_class$9 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  return DropdownItem;
}(React.PureComponent), (_applyDecoratedDescriptor(_class$9.prototype, "onMouseDown", [autobind], Object.getOwnPropertyDescriptor(_class$9.prototype, "onMouseDown"), _class$9.prototype)), _class$9);
...
var Dropdown = autobind(_class$a = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", _extends({}, props, {
        ...
        item: this.state.selected,
        accessor: accessor
      }), this.state.open && items ? /*#__PURE__*/React.createElement("div", {
...
var DropdownWithLabel = function DropdownWithLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "dropdown-with-label ".concat(className),
    label: label,
    mandatory: mandatory
...
var InputWithLabel = function InputWithLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "input-with-label ".concat(className),
    label: label,
    mandatory: mandatory
...
var TableLoader = function TableLoader(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(DashLoader, null), /*#__PURE__*/React.createElement(Text, {
    value: loadingText
  }))) : null;
};
/**
...
var Table = React.forwardRef(function (_ref2, ref) {
  ...
  return /*#__PURE__*/React.createElement(ReactTable, _extends({
    ref: ref,
...
var ManualTable = autobind(_class$b = /*#__PURE__*/function (_React$Component) {
  _inherits(ManualTable, _React$Component);

  var _super = _createSuper(ManualTable);
  ...
  _createClass(ManualTable, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!isEqual_1(this.props.defaultFilter, prevProps.defaultFilter)) this.setState({
        filter: _objectSpread2(_objectSpread2({}, this.state.filter), this.props.defaultFilter)
      });
      if (!isEqual_1(this.props.defaultSort, prevProps.defaultSort)) this.setState({
        sort: _objectSpread2(_objectSpread2({}, this.state.sort), this.props.defaultSort)
      });
    ...
    value: function onFiltersUpdate(filters) {
      this.setState({
        filter: _objectSpread2({}, filters.reduce(function (acc, filter) {
          return _objectSpread2(_objectSpread2({}, acc), {}, _defineProperty({}, filter.id, filter.value));
        }, {}))
      });
      return true;
    }
    ...
    value: function onSortsUpdate(sorts) {
      this.setState({
        sort: _objectSpread2({}, sorts.reduce(function (acc, sort) {
          return _objectSpread2(_objectSpread2({}, acc), {}, _defineProperty({}, sort.id, sort.desc ? -1 : 1));
        }, {}))
      });
      return true;
    }
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["className", "defaultFilter", "defaultSort", "getData", "getDataOnFilterChangeDelay", "pageSize"]);
      ...
      return /*#__PURE__*/React.createElement(Table, _extends({
        className: "manual-table ".concat(className),
        showPageJump: false,
        ofText: ''
      }, props, {
        manual: true,
...
var Modal = (_class$c = /*#__PURE__*/function (_React$Component) {
  ...
  return Modal;
}(React.Component), (_applyDecoratedDescriptor(_class$c.prototype, "onMouseDown", [autobind], Object.getOwnPropertyDescriptor(_class$c.prototype, "onMouseDown"), _class$c.prototype), _applyDecoratedDescriptor(_class$c.prototype, "onMouseUp", [autobind], Object.getOwnPropertyDescriptor(_class$c.prototype, "onMouseUp"), _class$c.prototype), _applyDecoratedDescriptor(_class$c.prototype, "onKeyDown", [autobind], Object.getOwnPropertyDescriptor(_class$c.prototype, "onKeyDown"), _class$c.prototype)), _class$c);
Modal.propTypes = {
  /**
...
var _class$d, _class2;
var DefaultMultiSelectListItem = (_class$d = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(DefaultMultiSelectListItem, _React$PureComponent);

  var _super = _createSuper(DefaultMultiSelectListItem);
...
}(React.PureComponent), (_applyDecoratedDescriptor(_class$d.prototype, "onDeselectClick", [autobind], Object.getOwnPropertyDescriptor(_class$d.prototype, "onDeselectClick"), _class$d.prototype)), _class$d);
/**
...
var MultiSelect = autobind(_class2 = /*#__PURE__*/function (_React$Component) {
  _inherits(MultiSelect, _React$Component);

  var _super2 = _createSuper(MultiSelect);
...
var MultiSelectWithLabel = function MultiSelectWithLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "multi-select-with-label ".concat(className),
    label: label,
    mandatory: mandatory
  }, /*#__PURE__*/React.createElement(MultiSelect, multiSelectProps));
};
...
var ProgressLoader = (_class$e = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ProgressLoader, _React$PureComponent);

  var _super = _createSuper(ProgressLoader);
  ...
  _createClass(ProgressLoader, [{
    ...
    value: function render() {
      ...
      }), /*#__PURE__*/React.createElement(CircularProgressbar, _extends({
        value: value,
...
}(React.PureComponent), (_applyDecoratedDescriptor(_class$e.prototype, "textForPercentage", [autobind], Object.getOwnPropertyDescriptor(_class$e.prototype, "textForPercentage"), _class$e.prototype)), _class$e);
...
var Radio = (_class$f = /*#__PURE__*/function (_React$PureComponent) {
...
var RadioWithLabel = (_class$g = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(RadioWithLabel, _React$PureComponent);

  var _super = _createSuper(RadioWithLabel);
...
}(React.PureComponent), (_applyDecoratedDescriptor(_class$g.prototype, "onClick", [autobind], Object.getOwnPropertyDescriptor(_class$g.prototype, "onClick"), _class$g.prototype)), _class$g);
...
var _RouterLink = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(_RouterLink, _React$PureComponent);

  var _super = _createSuper(_RouterLink);
...
var TextWithLabel = function TextWithLabel(_ref) {
  ...
  return textProps.value || !hideIfEmpty ? /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "text-with-label ".concat(className),
    label: label,
    mandatory: mandatory
...
var TextWithScrollbarAndLabel = function TextWithScrollbarAndLabel(_ref) {
  var className = _ref.className,
      label = _ref.label,
      _ref$mandatory = _ref.mandatory,
      mandatory = _ref$mandatory === void 0 ? false : _ref$mandatory,
      ...
      textProps = _ref$textProps === void 0 ? {} : _ref$textProps;
  return textProps.value || !hideIfEmpty ? /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "text-with-scrollbar-and-label ".concat(className),
    label: label,
    mandatory: mandatory
  }, /*#__PURE__*/React.createElement(ContentHeightScrollbar, _extends({}, scrollbarProps, {
...
var Textarea = autobind(_class$h = /*#__PURE__*/function (_React$PureComponent) {
...
var TextareaWithLabel = function TextareaWithLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "textarea-with-label ".concat(className),
    label: label,
    mandatory: mandatory
  }, /*#__PURE__*/React.createElement(Textarea, textareaProps));
};
...
var TextareaWithScrollbarAndLabel = function TextareaWithScrollbarAndLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(WrapWithLabel, {
    className: "textarea-with-scrollbar-and-label ".concat(className),
    label: label,
    mandatory: mandatory
  }, /*#__PURE__*/React.createElement(TextareaWithScrollbar, textareaWithScrollbarProps));
};
