...
var DefaultComboBoxItem = (_class$5 =
/*#__PURE__*/
function (_React$PureComponent) {
...
function (_React$Component) {
  ...
  function ComboBox(props) {
    ...
    _this.state = {
      open: false,
      filter: props.defaultFilter || _this.extractFilterFromItem(props.defaultSelected) || '',
  ...
  _createClass(ComboBox, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.props.defaultSelected !== this.state.selected && prevProps.defaultSelected !== this.props.defaultSelected) this.setState({
        ...
        filter: this.props.defaultFilter || this.extractFilterFromItem(this.props.defaultSelected) || this.state.filter
      });
    }
  }, {
    key: "onBlur",
    ...
    value: function filterFunction(item) {
      return this.props.filterFunction ? this.props.filterFunction(item, this.state.filter) : this.extractFilterFromItem(item).toLowerCase().includes(this.state.filter.toLowerCase());
    }
  }, {
    key: "extractFilterFromItem",
    value: function extractFilterFromItem(item) {
      return item ? this.props.displayField ? item[this.props.displayField] : "".concat(item) : '';
    }
  }, {
    key: "render",
    value: function render() {
...
var DefaultDropdownItem = (_class$6 =
/*#__PURE__*/
function (_React$PureComponent) {
...
var Dropdown = autobind(_class2$1 =
/*#__PURE__*/
function (_React$Component) {
...
var ManualTable = autobind(_class$7 =
/*#__PURE__*/
function (_React$Component) {
...
var DefaultMultiSelectListItem = (_class$9 =
/*#__PURE__*/
function (_React$PureComponent) {
...
var MultiSelect = autobind(_class2$2 =
/*#__PURE__*/
function (_React$Component) {
...
var Textarea = autobind(_class$d =
/*#__PURE__*/
function (_React$PureComponent) {
