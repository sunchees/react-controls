import { b as _inherits, c as _createClass, e as _classCallCheck, f as _possibleConstructorReturn, g as _getPrototypeOf, h as _objectSpread2, i as _defineProperty, j as _toConsumableArray, _ as _objectWithoutProperties, a as _extends } from './style-inject.es-4d895b0c.js';
...
function (_React$Component) {
  ...
  _createClass(ManualTable, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.state.filter !== prevState.filter || this.state.sort !== prevState.sort) {
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["defaultFilter", "defaultSort", "getData", "getDataDelay", "pageSize"]);
